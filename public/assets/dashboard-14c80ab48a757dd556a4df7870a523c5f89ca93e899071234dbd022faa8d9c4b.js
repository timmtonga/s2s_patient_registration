...
function addButton(parent, text, color){
  ...
  _button.innerHTML = I18n.t('forms.buttons.'+text.toLowerCase());
															...
															"content":[
																{
																	...
																	"content":'<img id="uigender" style="height: 60px;width:60px;" src="images/' + (String(fieldset["demographics"]["gender"]).toLowerCase() == "m" ? "male" : "female") + '.png" height="30" />',
																	"id":"cellGender"
																},
																{
																	"control":"div",
															...
															"content":[
																{
																	"control":"div",
																	"class":"cell",
																	"style":"height: 45px; font-size: 28px; width: 290px; vertical-align: middle;text-align:right;padding-right:5px;",
																	"content": I18n.t('menu.terms.scan_barcode')
																},
																{
																	"control":"div",
																	"class":"cell",
																					...
																					"content":[
																						{
																							...
																							"content":I18n.t("menu.terms.facility"),
																							"id":"uifield1"
																						},
																						{
																							"control":"div",
																						...
																						},
																						{
																							...
																							"class":"cell5",
                                                                                            "style":"font-size:20px;",
																							"content":I18n.t("menu.terms.date"),
																							"id":"uifield2"
																						},
																						{
																							"control":"div",
																					...
																					"content":[
																						{
																							...
																							"class":"cell6",
                                                                                            "style":"font-size:20px;",
																							"content":I18n.t("menu.terms.location"),
																							"id":"uifield3"
																						},{
																							"control":"div",
																							"class":"cell4",
																							...
																							"class":"cell7",
                                                                                            "style":"font-size:20px;",
																							"content":I18n.t("menu.terms.user"),
																							"id":"uifield4"
																						},{
																							"control":"div",
																							"class":"cell4",
				...
				case "barcode":
					...
					if(__$("uibarcodetext")){
						...
						if(!__$("targetbarcode")){
							...
							__$("uibarcodetext").innerHTML = "<form id='barcodescan' action='" + (barcodeDestination != undefined ? barcodeDestination : "/") + "' method='get'><input type='hidden' id='targetbarcode' name='identifier' value='' /></form>";
